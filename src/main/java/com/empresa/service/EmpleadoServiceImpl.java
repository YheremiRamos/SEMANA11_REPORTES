...
public class EmpleadoServiceImpl implements EmpleadoService{
	...
	@Override
	public List<Empleado> listaConsultaEmpleado(int estado, int idPais, String nombre, Date desde, Date hasta) {
		return repository.listaConsultaEmpleado(estado, idPais, nombre, desde, hasta);
	}
